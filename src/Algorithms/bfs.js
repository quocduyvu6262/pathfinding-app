/**
 * Breadth First Search implementation with adjacency matrix.
 ...
 * @return 'distances' array containing the shortest distances from the given start node to each other node
 */
